...
lint-py:  ## run python linter with ruff
	python -m ruff check finance_datagen
	python -m ruff format --check finance_datagen
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix finance_datagen
	python -m ruff format finance_datagen
...
test-py:  ## run python tests
	python -m pytest -v finance_datagen/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v finance_datagen/tests --cov=finance_datagen --cov-report term-missing --cov-report xml
